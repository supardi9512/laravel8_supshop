            ...
            <div class="card-body px-0 py-3">
                ...
                <div class="tab-pane fade show active" id="home2" role="tabpanel" aria-labelledby="home2-tab">
                    ...
                    <li>
                        ...
                        <div class="position-relative mr-3">
                            <img class="rounded-circle" src="{{ asset('admin/assets/img/user/u2.jpg') }}" alt="Image">
                    ...
                    <li>
                        ...
                        <div class="position-relative mr-3">
                            <img class="rounded-circle" src="{{ asset('admin/assets/img/user/u1.jpg') }}" alt="Image">
                    ...
                    <li>
                        <a href="javscript:void(0)" class="media media-message media-notification">
                        <div class="position-relative mr-3">
                            <img class="rounded-circle" src="{{ asset('admin/assets/img/user/u5.jpg') }}" alt="Image">
                            <span class="status away"></span>
                        </div>
                        <div class="media-body d-flex justify-content-between">
                            <div class="message-contents">
                ...
                <div class="tab-pane fade" id="profile2" role="tabpanel" aria-labelledby="profile2-tab">
                    ...
                    <li>
                        <a href="javscript:void(0)" class="media media-message media-notification">
                        <div class="position-relative mr-3">
                            <img class="rounded-circle" src="{{ asset('admin/assets/img/user/u6.jpg') }}" alt="Image">
                            <span class="status away"></span>
                        </div>
                        <div class="media-body d-flex justify-content-between">
                            <div class="message-contents">
                    ...
                    <li>
                        <a href="javscript:void(0)" class="media media-message media-notification">
                        <div class="position-relative mr-3">
                            <img class="rounded-circle" src="{{ asset('admin/assets/img/user/u7.jpg') }}" alt="Image">
                            <span class="status away"></span>
                        </div>
                        <div class="media-body d-flex justify-content-between">
                            <div class="message-contents">
